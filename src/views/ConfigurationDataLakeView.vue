  ...
  <BaseConfigurationView>
    ...
    <template #content>
      <div
        ...
        :class="interfaceStore.isOnSmallScreen ? 'max-w-[80vw] max-h-[90vh]' : 'max-w-[90vh] max-h-[85vh]'"
      >
        <ExpansiblePanel no-top-divider no-bottom-divider :is-expanded="!interfaceStore.isOnPhoneScreen">
          ...
          <template #content>
            <div class="flex justify-center flex-col ml-2 mb-8 mt-2 w-[800px]">
              ...
              <v-data-table
                ...
                items-per-page="10"
                class="elevation-1 bg-transparent rounded-lg data-table-container w-[800px]"
                theme="dark"
                :style="interfaceStore.globalGlassMenuStyles"
                :headers="[
                  { title: 'Name', align: 'start', key: 'name', width: '240px', fixed: true },
              ...
              >
                <template #item="{ item }">
                  <tr>
                    <td>
                      <div class="flex items-center justify-left rounded-xl mx-1 w-[240px]">
                    ...
                    <td>
                      <div class="flex items-center justify-start gap-2 rounded-xl mx-1">
                        <p class="w-[240px] whitespace-nowrap overflow-hidden text-ellipsis">{{ item.id }}</p>
                        <button
                          :class="[
