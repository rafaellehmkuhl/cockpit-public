        ...
        <ExpansiblePanel no-bottom-divider :is-expanded="!interfaceStore.isOnPhoneScreen">
          ...
          <template #content>
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-amber-100 text-sm">
                    Video processing is not available in the browser version. Your recordings will be saved as raw chunks
                    that can be downloaded and processed using the standalone version of Cockpit.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="flex items-center justify-start w-[96%] ml-2">
              ...
              />
              <v-tooltip
                :text="isElectron() ? 'Process videos in real-time during recording for instant availability when recording stops' : 'Live video processing is only available in the standalone version'"
              >
            ...
            <div class="flex items-center justify-start w-[96%] ml-2">
              <v-checkbox
                v-model="videoStore.saveBackupRawChunks"
