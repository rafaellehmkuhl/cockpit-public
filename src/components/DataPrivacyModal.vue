...
const setShareHardwareDetails = (value: boolean | null): void => {
  console.info(`[UserAction] ${value ? 'Enabled' : 'Disabled'} sharing of detailed hardware specifications`)
  shareHardwareDetails.value = Boolean(value)
}

const openDataPrivacyDocs = (): void => {
  console.info('[UserAction] Opened data privacy documentation link')
}
 ...
 */
const close = (): void => {
  console.info('[UserAction] Closed Data Privacy dialog')
