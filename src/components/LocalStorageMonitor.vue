  ...
  <div v-if="isOpen" class="local-storage-monitor">
    <div class="header">
      ...
      <div class="version-info">
        ...
        <v-btn density="compact" :loading="isLoading" :disabled="isLoading" @click="clearVersions">
          Clear Versions
        </v-btn>
        <v-btn density="compact" color="warning" :loading="isLoading" :disabled="isLoading" @click="clearAllHistory">
          Clear History
        </v-btn>
    ...
    <div v-if="versions.length > 1" class="versions-container">
      <div v-for="(version, displayIndex) in reversedVersions" :key="displayIndex" class="version-card">
        <div class="version-header" @click="toggleCollapse(displayIndex)">
          <div class="version-title">
            ...
            <span
              ...
              class="change-count"
              :title="`${getVersionChangeCount(displayIndex)?.additions} additions, ${
                getVersionChangeCount(displayIndex)?.removals
              } removals`"
            >
        ...
        <transition name="collapse-expand">
          <div v-show="!isVersionCollapsed(displayIndex)" class="diff-content">
