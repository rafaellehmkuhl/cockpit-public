 ...
 */
export const mdiIconNames: string[] = [
  'mdi-ab-testing',
  'mdi-abacus',
  'mdi-abjad-arabic',
  'mdi-abjad-hebrew',
  ...
  'mdi-battery-charging-wireless10',
  'mdi-battery-charging-wireless20',
  'mdi-battery-charging-wireless30',
  'mdi-battery-charging-wireless40',
  'mdi-battery-charging-wireless50',
  'mdi-battery-charging-wireless60',
  'mdi-battery-charging-wireless70',
  'mdi-battery-charging-wireless80',
  'mdi-battery-charging-wireless90',
  'mdi-battery-charging10',
  'mdi-battery-charging100',
  'mdi-battery-charging20',
  'mdi-battery-charging30',
  'mdi-battery-charging40',
  'mdi-battery-charging50',
  'mdi-battery-charging60',
  'mdi-battery-charging70',
  'mdi-battery-charging80',
  'mdi-battery-charging90',
  'mdi-battery-check',
  ...
  'mdi-battery10',
  'mdi-battery10-bluetooth',
  'mdi-battery20',
  'mdi-battery20-bluetooth',
  'mdi-battery30',
  'mdi-battery30-bluetooth',
  'mdi-battery40',
  'mdi-battery40-bluetooth',
  'mdi-battery50',
  'mdi-battery50-bluetooth',
  'mdi-battery60',
  'mdi-battery60-bluetooth',
  'mdi-battery70',
  'mdi-battery70-bluetooth',
  'mdi-battery80',
  'mdi-battery80-bluetooth',
  'mdi-battery90',
  'mdi-battery90-bluetooth',
  'mdi-beach',
  'mdi-beaker',
  'mdi-beaker-alert',
  ...
  'mdi-network-strength1',
  'mdi-network-strength1-alert',
  'mdi-network-strength2',
  'mdi-network-strength2-alert',
  'mdi-network-strength3',
  'mdi-network-strength3-alert',
  'mdi-network-strength4',
  'mdi-network-strength4-alert',
  'mdi-network-strength4-cog',
  'mdi-new-box',
  'mdi-newspaper',
  'mdi-newspaper-check',
  'mdi-newspaper-minus',
  ...
  'mdi-null',
  'mdi-numeric',
  'mdi-numeric-negative1',
  'mdi-numeric-off',
  'mdi-numeric-positive1',
  'mdi-numeric0',
  'mdi-numeric0-box',
  'mdi-numeric0-box-multiple',
  'mdi-numeric0-box-multiple-outline',
  'mdi-numeric0-box-outline',
  'mdi-numeric0-circle',
  'mdi-numeric0-circle-outline',
  'mdi-numeric1',
  'mdi-numeric1-box',
  'mdi-numeric1-box-multiple',
  'mdi-numeric1-box-multiple-outline',
  'mdi-numeric1-box-outline',
  'mdi-numeric1-circle',
  'mdi-numeric1-circle-outline',
  'mdi-numeric10',
  'mdi-numeric10-box',
  'mdi-numeric10-box-multiple',
  'mdi-numeric10-box-multiple-outline',
  'mdi-numeric10-box-outline',
  'mdi-numeric10-circle',
  'mdi-numeric10-circle-outline',
  'mdi-numeric2',
  'mdi-numeric2-box',
  'mdi-numeric2-box-multiple',
  'mdi-numeric2-box-multiple-outline',
  'mdi-numeric2-box-outline',
  'mdi-numeric2-circle',
  'mdi-numeric2-circle-outline',
  'mdi-numeric3',
  'mdi-numeric3-box',
  'mdi-numeric3-box-multiple',
  'mdi-numeric3-box-multiple-outline',
  'mdi-numeric3-box-outline',
  'mdi-numeric3-circle',
  'mdi-numeric3-circle-outline',
  'mdi-numeric4',
  'mdi-numeric4-box',
  'mdi-numeric4-box-multiple',
  'mdi-numeric4-box-multiple-outline',
  'mdi-numeric4-box-outline',
  'mdi-numeric4-circle',
  'mdi-numeric4-circle-outline',
  'mdi-numeric5',
  'mdi-numeric5-box',
  'mdi-numeric5-box-multiple',
  'mdi-numeric5-box-multiple-outline',
  'mdi-numeric5-box-outline',
  'mdi-numeric5-circle',
  'mdi-numeric5-circle-outline',
  'mdi-numeric6',
  'mdi-numeric6-box',
  'mdi-numeric6-box-multiple',
  'mdi-numeric6-box-multiple-outline',
  'mdi-numeric6-box-outline',
  'mdi-numeric6-circle',
  'mdi-numeric6-circle-outline',
  'mdi-numeric7',
  'mdi-numeric7-box',
  'mdi-numeric7-box-multiple',
  'mdi-numeric7-box-multiple-outline',
  'mdi-numeric7-box-outline',
  'mdi-numeric7-circle',
  'mdi-numeric7-circle-outline',
  'mdi-numeric8',
  'mdi-numeric8-box',
  'mdi-numeric8-box-multiple',
  'mdi-numeric8-box-multiple-outline',
  'mdi-numeric8-box-outline',
  'mdi-numeric8-circle',
  'mdi-numeric8-circle-outline',
  'mdi-numeric9',
  'mdi-numeric9-box',
  'mdi-numeric9-box-multiple',
  'mdi-numeric9-box-multiple-outline',
  'mdi-numeric9-box-outline',
  'mdi-numeric9-circle',
  'mdi-numeric9-circle-outline',
  'mdi-numeric9-plus',
  'mdi-numeric9-plus-box',
  'mdi-numeric9-plus-box-multiple',
  'mdi-numeric9-plus-box-multiple-outline',
  'mdi-numeric9-plus-box-outline',
  'mdi-numeric9-plus-circle',
  'mdi-numeric9-plus-circle-outline',
  'mdi-nut',
  'mdi-nutrition',
  'mdi-nuxt',
  'mdi-oar',
  ...
  'mdi-printer3d',
  'mdi-printer3d-nozzle',
  'mdi-printer3d-nozzle-alert',
  'mdi-printer3d-nozzle-alert-outline',
  'mdi-printer3d-nozzle-heat',
  'mdi-printer3d-nozzle-heat-outline',
  'mdi-printer3d-nozzle-off',
  'mdi-printer3d-nozzle-off-outline',
  'mdi-printer3d-nozzle-outline',
  'mdi-printer3d-off',
  'mdi-priority-high',
  'mdi-priority-low',
  ...
  'mdi-signal-cellular1',
  'mdi-signal-cellular2',
  'mdi-signal-cellular3',
  ...
  'mdi-soccer',
  'mdi-soccer-field',
  'mdi-social-distance2-meters',
  'mdi-social-distance6-feet',
  'mdi-sofa',
  'mdi-sofa-outline',
  'mdi-sofa-single',
  ...
  'mdi-surfing',
  'mdi-surround-sound',
  'mdi-surround-sound20',
  'mdi-surround-sound21',
  'mdi-surround-sound31',
  'mdi-surround-sound51',
  'mdi-surround-sound512',
  'mdi-surround-sound71',
  'mdi-svg',
  'mdi-swap-horizontal',
  ...
  'mdi-wifi-strength1',
  'mdi-wifi-strength1-alert',
  'mdi-wifi-strength1-lock',
  'mdi-wifi-strength1-lock-open',
  'mdi-wifi-strength2',
  'mdi-wifi-strength2-alert',
  'mdi-wifi-strength2-lock',
  'mdi-wifi-strength2-lock-open',
  'mdi-wifi-strength3',
  'mdi-wifi-strength3-alert',
  'mdi-wifi-strength3-lock',
  'mdi-wifi-strength3-lock-open',
  'mdi-wifi-strength4',
  'mdi-wifi-strength4-alert',
  'mdi-wifi-strength4-lock',
  'mdi-wifi-strength4-lock-open',
  'mdi-wifi-sync',
  'mdi-wikipedia',
  'mdi-wind-power',
