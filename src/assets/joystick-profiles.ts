...
export const cockpitStandardToProtocols: JoystickProtocolActionsMapping = {
  ...
  buttonsCorrespondencies: {
    [CockpitModifierKeyOption.regular]: {
      ...
      [JoystickButton.B2]: { action: mavlinkManualControlButtonFunctions['Mount tilt down'] },
      [JoystickButton.B3]: { action: availableCockpitActions.go_to_next_view },
    ...
    [CockpitModifierKeyOption.shift]: {
      [JoystickButton.B0]: { action: mavlinkManualControlButtonFunctions['Disarm'] },
      [JoystickButton.B1]: { action: otherAvailableActions.no_function },
      [JoystickButton.B2]: { action: otherAvailableActions.no_function },
      [JoystickButton.B3]: { action: availableCockpitActions.toggle_full_screen },
