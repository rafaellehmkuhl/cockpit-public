...
graph TD;
    ...
    2A-->2B[Set currentUser=lastConnectedUser]
    2B-->3{Cockpit has the new version of the synced settings?}
    ...
    3-->|Yes| 3B{Cockpit has settings for user=currentUser and vehicle=lastConnectedVehicle?}
    ...
    5A-->5A1[Set currentUser=lastConnectedUser]
    5A1-->3B
